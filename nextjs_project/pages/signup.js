      ...
      <div className={styles.colleft}>
        <Col className={styles.col1}>
          ...
          <div class="form-floating mb-3" dir="rtl">
            ...
            <label for="floatingInput" className={styles.input}>الاسم كامل<AccountCircleIcon /></label>
          </div>
          <div class="form-floating mb-3" dir="rtl">
            <input type="email" class="form-control" id="floatingEmail" placeholder="الايميل" />
            <label for="floatingEmail" className={styles.input}>الايميل<EmailIcon /></label>
          </div>
          <div class="form-floating mb-3" dir="rtl">
            <input type="password" class="form-control" id="floatingPassword" placeholder="كلمة المرور" />
            <label for="floatingPassword" className={styles.input}>كلمة المرور <VisibilityIcon /></label>
          </div>
          <div class="form-floating mb-3" dir="rtl">
            <input type="text" class="form-control" id="floatingInput" placeholder="البلد" />
            <label for="floatingInput" className={styles.input}>البلد<LocationCityIcon /></label>
          </div>
          <div className={styles.bakbtn}>
            <button type="button" className={styles.btn}>انشاء حساب</button>
          </div>
        </Col>
