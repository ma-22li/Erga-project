    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='example@email.com', max_length=254, unique=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='city_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='register.city'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
